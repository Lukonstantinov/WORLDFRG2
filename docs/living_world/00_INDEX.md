...
| 02 | [`02_PEOPLE.md`](02_PEOPLE.md) | PARTIAL — slices 02.1-02.6, 02.8-02.9 done; only 02.7 (faces, needs a display to verify) left, see doc §Queue | 01 | ONE Person system: life from debut (≥16) to death, traits, modifiers, the 75 % decision rule, faces, world-linked life events, 40 notables + Hall of the Dead |
