...
export const GOOD_DEFS: GoodDef[] = [
  ...
  { name: "oliveoil", label: "Olive Oil", emoji: "\u{1F376}", color: "#8ea33a" },
  { name: "sugar", label: "Sugar Cane", emoji: "\u{1F38B}", color: "#c8d69a" },
  { name: "frankincense", label: "Frankincense", emoji: "\u{1F56F}", color: "#c79a4b" },
  ...
  { name: "timber", label: "Timber", emoji: "\u{1F332}", color: "#6b8f4e" },
  { name: "amber", label: "Amber", emoji: "\u{1F536}", color: "#e0962a" },
  ...
  { name: "cotton", label: "Cotton", emoji: "\u{2601}", color: "#eef0e8" },
  ...
  { name: "copper", label: "Copper", emoji: "\u{1F949}", color: "#b06a3a" },
  { name: "tin", label: "Tin", emoji: "\u{26AA}", color: "#b8bcc0" },
  { name: "gold", label: "Gold", emoji: "\u{1F947}", color: "#d4af37" },
  ...
  { name: "glassware", label: "Glassware", emoji: "\u{1F52E}", color: "#9fd8d0" },
  { name: "tobacco", label: "Tobacco", emoji: "\u{1F6AC}", color: "#8a6a3a" },
  { name: "indigo", label: "Indigo", emoji: "\u{1F535}", color: "#3a4fb0" },
  ...
  { name: "flax", label: "Flax / Linen", emoji: "\u{1F331}", color: "#cfe0e8" },
  { name: "coral", label: "Red Coral", emoji: "\u{1F41A}", color: "#ff6f61" },
  { name: "cinnamon", label: "Cinnamon", emoji: "\u{1F33F}", color: "#a9603a" },
  { name: "saffron", label: "Saffron", emoji: "\u{1F33C}", color: "#f4c430" },
  { name: "tyrian_purple", label: "Tyrian Purple", emoji: "\u{1F40C}", color: "#6a0dad" },
  { name: "ambergris", label: "Ambergris", emoji: "\u{1F40B}", color: "#cfc0a0" },
  { name: "jade", label: "Jade", emoji: "\u{2618}", color: "#00a86b" },
  { name: "silver", label: "Silver", emoji: "\u{1F948}", color: "#c8ccd6" },
  ...
  { name: "amethyst", label: "Amethyst", emoji: "\u{1F49C}", color: "#9b59d0" },
  { name: "topaz", label: "Topaz", emoji: "\u{1F538}", color: "#e0a92a" },
  // ── Clay (raw input) + manufactured chain goods (mirror goods_spec.rs) ──
  { name: "clay", label: "Clay", emoji: "\u{1F94C}", color: "#b07a52" },
  { name: "cloth", label: "Woolen Cloth", emoji: "\u{1F45A}", color: "#d8c8b0" },
  ...
  { name: "linen", label: "Linen", emoji: "\u{1F454}", color: "#cfe0e8" },
  { name: "cotton_cloth", label: "Cotton Cloth", emoji: "\u{1F455}", color: "#eef0e8" },
  { name: "silk_brocade", label: "Fine Silk Brocade", emoji: "\u{1F458}", color: "#d96fb0" },
  { name: "carpets", label: "Carpets & Tapestry", emoji: "\u{1F3F5}", color: "#9b4f2f" },
  ...
  { name: "perfume", label: "Perfume & Attar", emoji: "\u{1F338}", color: "#c79a4b" },
  { name: "soap", label: "Soap", emoji: "\u{1F6C1}", color: "#cfe0d8" },
  ...
  { name: "furniture", label: "Fine Furniture", emoji: "\u{1F6CB}", color: "#6b4226" },
  ...
  // ── Goods added after this list was first written ─────────────────────
  // These ship in `default_custom_goods()` (the eight minerals of
  // DEPOSITS_AND_MINING_PLAN slice 3, and the six Endemic spice-island
  // goods of CLAUDE.md §8.20) and were never mirrored here, so every view
  // reading the STATIC list — and `goodsStore.meta`'s fallback when a world's
  // specs are not loaded — resolved them to nothing and drew the 📦 box.
  // Label, glyph and colour are copied from the Rust spec, which stays the
  // source of truth; this list is only the fallback.
  { name: "nutmeg", label: "Nutmeg", emoji: "\u{1F330}", color: "#8b5a2b" },
  { name: "mace", label: "Mace", emoji: "\u{1F53A}", color: "#d2691e" },
  { name: "dragons_blood", label: "Dragon's Blood Resin", emoji: "\u{2764}", color: "#a41d1d" },
  { name: "camphor", label: "Camphor", emoji: "\u{2744}", color: "#e8f4f8" },
  { name: "benzoin", label: "Benzoin", emoji: "\u{1F36F}", color: "#c98a3c" },
  { name: "sandalwood", label: "Sandalwood", emoji: "\u{1F334}", color: "#c8a165" },
  { name: "mercury", label: "Mercury", emoji: "\u{1F4A7}", color: "#c0c4ca" },
  { name: "alum", label: "Alum", emoji: "\u{2697}\u{FE0F}", color: "#e8e0c0" },
  { name: "lapis_lazuli", label: "Lapis Lazuli", emoji: "\u{1F30C}", color: "#26619c" },
  { name: "turquoise", label: "Turquoise", emoji: "\u{1F4A0}", color: "#30d5c8" },
  { name: "bog_iron", label: "Bog Iron", emoji: "\u{26CF}", color: "#5b4636" },
