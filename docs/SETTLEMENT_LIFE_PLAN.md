...
**Status: L0-L4 SHIPPED (all at dose 0 where dosed).** L0-L2 shipped
2026-09-23, L3 (annals + the Life tab) and L4 (vital rates + age bands) in
follow-up sessions — see CLAUDE.md §5.7 for the full account. L5-L13 remain
queued per the build order below. Originally written from a read of the campaign tick
