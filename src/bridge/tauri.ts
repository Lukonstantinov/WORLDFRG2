...
import type { CampaignSnapshot, JournalEntry, WorldEconomy, HubDetail, HouseBrief, HouseHistory, HouseLedger, CampaignDiagnostics, MerchantRoute, CityRank, ContractRow, SpecCenter, PolisBrief, CurrencyBrief, BankBrief, CrashRecord, CitySchematic, WarsPayload } from "../types";
...
export async function campaignGetContracts(): Promise<ContractRow[]> {
  return invoke("campaign_get_contracts");
}
