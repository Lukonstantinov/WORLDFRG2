...
- **Real climatology.** Wind belts, ITCZ migration, orographic rain shadows, ocean gyres, boundary currents, upwelling, a thermohaline "conveyor", and a full **Köppen** classification (22+ zones).
...
- **45 trade goods with production chains.** ~22 climate/terrain-distributed belts plus discrete mineral **deposits**, plus **manufactured** goods made in cities from recipes (e.g. wool + dyes → cloth) via a shared production-chain resolver.
