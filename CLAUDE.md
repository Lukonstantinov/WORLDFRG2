...
Twenty-two documents (feature catalogs, trade/cartography specs, Victoria-2 UI
...
designs) live in `docs/proposals/`. They were being read by fresh sessions as a backlog to work through,
