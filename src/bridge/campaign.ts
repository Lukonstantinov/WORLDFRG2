...
/** TRADE_STAGING_AND_POSTS_PLAN.md Slice 7 — the Trading Posts roster. */
export async function campaignGetTradingPosts(): Promise<TradingPost[]> {
  return invoke("campaign_get_trading_posts");
}
