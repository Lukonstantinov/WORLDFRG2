...
| 03 | [`03_DEVELOPMENT_TRACKS.md`](03_DEVELOPMENT_TRACKS.md) | PARTIAL — slice 03.1 done (the dev factor itself, read by nothing yet), see doc §Slices | 02 | Per-city development factor (replaces the dead global `tech_factor`), four tracks (Military · Trade · Civil · Ideological), buildings, culture "ideals" and the barbarian judgement |
