...
| 04 | [`04_GOVERNMENT_AND_EDICTS.md`](04_GOVERNMENT_AND_EDICTS.md) | PARTIAL — slices 04.1-04.2 done, see doc §Queue | 02, 03 | Government forms, offices (cultural and custom), named seat holders, political points, edicts debated in weekly rounds, the Lustrum, bribery, coups, ostracism, the Government window |
